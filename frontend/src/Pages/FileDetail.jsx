...
function FileDetail() {
  ...
  const fileSize =
    ((file.document?.fileSize || 0) / 1024 / 1024).toFixed(1);
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-6 mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs" style={{ color: "#64748b" }}>Views</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs" style={{ color: "#64748b" }}>Downloads</p>
                  <p className="text-lg font-semibold">0</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-xs" style={{ color: "#64748b" }}>Uploaded</p>
